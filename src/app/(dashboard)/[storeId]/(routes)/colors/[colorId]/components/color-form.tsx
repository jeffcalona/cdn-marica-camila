...
const formSchema = z.object({
    name: z.string().min(1, {
        message: 'El color debe contener al menos un caracter'
    }),
    value: z.string().min(4).regex(/^#/, {
        message: 'la cadena de texto debe ser un código hexadecimal válido'
    })
})
...
export const ColorForm: React.FC<ColorFormProps> = ({
    ...
    const onDelete = async () => {
        try {
            ...
            toast.error('Asegúrate de eliminar todos los productos que utilicen este color primero')
        } finally {
            setLoading(false)
            setOpen(false)
        }
